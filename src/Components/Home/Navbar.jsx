  ...
  return (
    <div className="w-full md:mt-2 flex justify-between items-center h-15">
      <div className="hidden md:flex justify-between items-center w-[90%]  mx-auto">
        ...
        <ul className="flex cursor-pointer w-[50%] space-x-10">
          <li onClick={()=> navigate("/")} className="rounded-2xl transition-1s duration-100 hover:bg-[#FC8A06] px-2.5 py-1" href="">
            Home
          </li>
        ...
        >
          ...
          <button className="h-full cursor-pointer flex">
            {currentUser?.name
      ...
      <div className="md:hidden  flex w-full justify-around  items-center">
        ...
        <div
          ...
          className="flex justify-center cursor-pointer  h-16  bg-[#028643] space-x-2 items-center w-[50%] "
        >
